...
const string AppBin = "/usr/bin/Fulcrum";
const string ConfigPath = "/fulcrum/etc/fulcrum.conf";
const string DefaultConfigPath = "/usr/share/fulcrum/fulcrum.conf.example";
...
static void Exec()
{
    var defaults = new[]
    {
        ConfigPath,
        "--datadir", "/fulcrum/var",
        "--pidfile", "/fulcrum/run/fulcrum.pid",
    };
